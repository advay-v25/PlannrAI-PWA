...
const PILLAR_COLORS: Record<string, { accent: string; bg: string; border: string; edge: string }> = {
    mind: { accent: 'text-[#7C6FC0] dark:text-[#A99CE0]', bg: 'bg-[#FFFFFF] dark:bg-[#1B1B20]', border: 'border border-[#E7E4DC] dark:border-[#2A2A31]', edge: '' },
    body: { accent: 'text-[#5F9377] dark:text-[#8FBFA3]', bg: 'bg-[#FFFFFF] dark:bg-[#1B1B20]', border: 'border border-[#E7E4DC] dark:border-[#2A2A31]', edge: '' },
    craft: { accent: 'text-[#B9954C] dark:text-[#D6BB80]', bg: 'bg-[#FFFFFF] dark:bg-[#1B1B20]', border: 'border border-[#E7E4DC] dark:border-[#2A2A31]', edge: '' },
    meal: { accent: 'text-[#B97F6E] dark:text-[#D6A797]', bg: 'bg-[#FFFFFF] dark:bg-[#1B1B20]', border: 'border border-[#E7E4DC] dark:border-[#2A2A31]', edge: '' },
    soul: { accent: 'text-zinc-900 dark:text-rose-400', bg: 'bg-[#FFFFFF] dark:bg-[#1B1B20]', border: 'border border-[#E7E4DC] dark:border-[#2A2A31]', edge: '' },
};
