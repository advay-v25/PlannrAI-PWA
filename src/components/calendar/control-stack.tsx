        ...
        <div className="flex flex-col gap-4 h-full">
            ...
            <GlassCard padding="lg" className="space-y-3 bg-gradient-to-br from-primary/10 to-blue-500/5 border-primary/20">
                ...
                <button
                    ...
                    className="w-full flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 transition-all text-left group"
                >
                    ...
                    <div>
                        <div className="text-sm font-medium text-white">Optimize Day</div>
                        <div className="text-[10px] text-white/40">Align energy & focus</div>
                    </div>
                </button>
                ...
                >
                    ...
                    <div>
                        <div className="text-sm font-medium text-white">Plan Week</div>
                        <div className="text-[10px] text-white/40">Full schedule generate</div>
                    </div>
                </button>
            </GlassCard>
                ...
                <div className="pt-4 border-t border-white/5">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {['Mind', 'Body', 'Craft'].map(p => (
                            <button
                                key={p}
                                className="px-3 py-1.5 rounded-lg text-[10px] font-bold bg-white/5 hover:bg-white/10 border border-white/5 text-white/60"
                            >
                                {p}
                            </button>
                        ))}
    ...
    return (
        ...
        >
            ...
            <div className={cn(
                ...
                active ? "bg-[var(--color-primary)]" : "bg-white/10"
            )} />
        </button>
    )
}
