    ...
    return (
        <div className={`rounded-xl border p-4 backdrop-blur-md transition-all ${priorityStyles[suggestion.severity]}`}>
            ...
            <div className="mt-4 flex space-x-3">
                <button
                    onClick={onAct}
                    className="px-4 py-2 bg-[var(--color-primary)] text-[var(--text-primary)] text-sm font-medium rounded-lg hover:brightness-110 active:scale-95 transition-all shadow-lg"
                >
                    {suggestion.action}
                </button>
                <button
