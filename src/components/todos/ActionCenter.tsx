            ...
            >
                <defs>
                    ...
                    <linearGradient id="flowStroke1" x1="0%" y1="0%" x2="100%" y2="0%">
                        ...
                        <stop offset="30%" stopColor="#F97316" stopOpacity="0.28" />
                        <stop offset="70%" stopColor="#EF4444" stopOpacity="0.20" />
                ...
                {/* Flowing filled shapes */}
                <path
                    d="M-50 200 C150 100, 350 300, 500 180 S750 50, 1050 250 L1050 350 C750 150, 550 380, 400 280 S150 200, -50 300 Z"
                    fill="url(#flow1)"
                />
                <path
                    d="M-50 500 C200 400, 300 600, 500 480 S700 350, 1050 550 L1050 650 C700 450, 500 680, 350 580 S200 500, -50 600 Z"
                    fill="url(#flow2)"
                />
                <path
                    d="M-50 800 C100 700, 400 900, 600 780 S800 650, 1050 850 L1050 950 C800 750, 600 980, 400 880 S100 800, -50 900 Z"
                    fill="url(#flow3)"
                />

                {/* Elegant flowing stroke lines */}
                <path
                    d="M0 150 C200 80, 400 220, 600 150 S900 50, 1000 180"
                    stroke="url(#flowStroke1)"
                    strokeWidth="2.5"
                    fill="none"
                />
                <path
                    d="M0 280 C150 220, 350 340, 550 260 S800 180, 1000 300"
                    stroke="url(#flowStroke2)"
                    strokeWidth="2"
                    fill="none"
                />
                <path
                    d="M0 450 C250 380, 400 520, 650 430 S850 350, 1000 480"
                    stroke="url(#flowStroke1)"
                    strokeWidth="2.5"
                    fill="none"
                />
                <path
                    d="M0 600 C180 540, 380 660, 580 580 S820 500, 1000 630"
                    stroke="url(#flowStroke2)"
                    strokeWidth="2"
                    fill="none"
                />
                <path
                    d="M0 750 C200 680, 450 800, 650 720 S880 640, 1000 770"
                    stroke="url(#flowStroke1)"
                    strokeWidth="2.5"
                    fill="none"
                />
                <path
                    d="M0 900 C160 840, 360 960, 560 880 S800 800, 1000 920"
                    stroke="url(#flowStroke2)"
                    strokeWidth="2"
                    fill="none"
                />
                <path
                    d="M0 1050 C220 980, 420 1100, 620 1020 S860 940, 1000 1070"
                    stroke="url(#flowStroke1)"
                    strokeWidth="1.5"
                    fill="none"
                />

                {/* Dot accents along the flow */}
                <circle cx="250" cy="140" r="3" fill="#F97316" opacity="0.30" />
                <circle cx="600" cy="155" r="2.5" fill="#EF4444" opacity="0.25" />
                <circle cx="450" cy="430" r="3.5" fill="#F59E0B" opacity="0.22" />
                <circle cx="750" cy="470" r="2.5" fill="#F97316" opacity="0.25" />
                <circle cx="300" cy="720" r="3" fill="#EF4444" opacity="0.22" />
                <circle cx="650" cy="770" r="3" fill="#F59E0B" opacity="0.25" />
                <circle cx="500" cy="900" r="2.5" fill="#F97316" opacity="0.18" />
            </svg>
