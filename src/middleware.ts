...
export async function middleware(request: NextRequest) {
    try {
        ...
        if ((pathname.startsWith('/api/habit-stack/') || pathname === '/api/habit-stack') || pathname.startsWith('/api/goals/plan') || pathname.startsWith('/api/goals/strategy') || pathname.startsWith('/api/goals/generate-strategy') || pathname.startsWith('/api/goals/auto-schedule')) {
