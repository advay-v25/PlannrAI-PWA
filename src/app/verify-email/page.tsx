...
export default function VerifyEmailPage() {
    return (
        <div className="min-h-screen min-h-dvh flex items-center justify-center p-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-950/40 via-neutral-950 to-neutral-950 overflow-hidden relative">
            ...
            >
                <GlassCard variant="glow" padding="lg" className="border-[var(--glass-border)] dark:border-white/10 shadow-2xl text-center">
                    <div className="relative z-10">
                        ...
                        <p className="text-[var(--text-secondary)] dark:text-white/60 mb-8 leading-relaxed">
                        ...
                        <div className="bg-[var(--glass-bg)] dark:bg-white/5 border border-[var(--glass-border)] dark:border-white/10 rounded-xl p-4 mb-8 text-left">
                            <h3 className="text-sm font-semibold text-[var(--text-primary)] dark:text-white mb-2 flex items-center gap-2">
                                <Inbox className="w-4 h-4 text-orange-400" />
                                Didn't receive the email?
                            </h3>
                            <ul className="text-xs text-[var(--text-secondary)] dark:text-white/50 list-disc list-inside space-y-1">
