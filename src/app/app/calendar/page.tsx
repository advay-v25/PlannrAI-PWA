                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-1 ml-2">
                            ...
                            <button onClick={() => setSelectedDate(new Date())}
                                className="px-3 py-1 rounded-lg text-xs font-bold text-white/60 hover:text-white hover:bg-white/10 transition-colors">
                                Today
                            </button>
                            <button onClick={() => navigateDate(1)}
                                className="p-1.5 rounded-lg hover:bg-white/10 text-white/40 hover:text-white transition-colors">
                        ...
                        <span className="text-base font-semibold text-white/70">{dateTitle}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex bg-white/[0.06] rounded-lg p-0.5">
                            <button onClick={() => setViewMode('day')}
                                className={cn("px-3 py-1.5 rounded-md text-xs font-bold transition-all",
                                    viewMode === 'day' ? "bg-orange-500 text-black" : "text-white/50 hover:text-white")}>
                                Day
                            </button>
                            <button onClick={() => setViewMode('week')}
                                className={cn("px-3 py-1.5 rounded-md text-xs font-bold transition-all",
                                    viewMode === 'week' ? "bg-orange-500 text-black" : "text-white/50 hover:text-white")}>
                                Week
                            </button>
                        </div>
                        ...
                        <button onClick={() => { setAddModalDefaults({}); setShowAddModal(true); }}
                            ...
                            bg-orange-500 text-black hover:bg-orange-400 transition-all shadow-lg shadow-orange-500/20">
                    ...
                    <div className="flex items-center gap-4 mt-2 pt-2 border-t border-white/[0.04]">
                        ...
                        <div className="flex items-center gap-1.5 text-[10px] text-white/30">
                            ...
                            <span className={cn("font-bold",
                                dayStats.pct >= 70 ? 'text-emerald-400' : dayStats.pct >= 30 ? 'text-orange-400' : 'text-white/50'
                            ...
                            <div className="flex-1 h-1 bg-white/[0.04] rounded-full overflow-hidden max-w-[200px]">
                                <motion.div
                                    ...
                                    className={cn("h-full rounded-full",
                                        dayStats.pct >= 70 ? 'bg-emerald-500' : dayStats.pct >= 30 ? 'bg-orange-500' : 'bg-white/20'
                                    )}
                                />
                            </div>
                        )}
